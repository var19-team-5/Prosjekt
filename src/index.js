        ...
        <Card>
          <ListGroup>
            ...
            <ListGroup.Item className="list-group-item">
              ...
              <Form.Control type="text" value={this.mobilnummer} onChange={e => (this.mobilnummer = e.target.value)} />
            </ListGroup.Item>
          </ListGroup>
        </Card>
        <Card>
          <ListGroup>
            <ListGroup.Item className="list-group-item">
              ...
              <Form.Control type="date" value={this.fra} onChange={e => (this.fra = e.target.value)} />
            </ListGroup.Item>
            <ListGroup.Item className="list-group-item">
              <Form.Label> Til: </Form.Label>
              <Form.Control type="date" value={this.til} onChange={e => (this.il = e.target.value)} />
            </ListGroup.Item>
          </ListGroup>
        </Card>
        <Card>
...
class Status extends Component {
  ...
  mounted() {
    bestillingService.hentKunder(mobilnummer => {
      this.kunder = mobilnummer;
    });
  }
}
