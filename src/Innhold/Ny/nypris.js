    ...
    render() {
      ...
      return[
        ...
        <Col>
         ...
         <Button value={this.nyPrisUtstyr()} onClick={() => this.visEndringPop()}>Legg til ny utstyr pris</Button>
         </ListGroup.Item>
         </Col>
        <Col>
          ...
          <ListGroup.Item className="list-group-item">
           ...
           <Form.Label>Pris:</Form.Label>
           <Form.Control type="number" onChange={e => (this.pris = e.target.value)} placeholder='00,00'/>
          <Button value={this.nyPrisSykkel()} onClick={() => this.visEndringPop()}>Legg til ny sykkel pris</Button>
        ...
        <Modal size="sm" show={this.state.endringPop} onHide={this.skjulEndringPop}>
          <Modal.Header closeButton>
            <Modal.Title>sykkel</Modal.Title>
          </Modal.Header>
          <Modal.Body>
